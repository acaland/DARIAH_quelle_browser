...
function getRelatedMultimediaList(id) {
  RPCManager.sendRequest({
    actionURL:
      "https://glibrary.ct.infn.it:3500/v2/repos/dariah/quelle/" +
      id +
      "/quelle_multimedia_liste",
    httpHeaders: { Authorization: access_token },
    httpMethod: "GET",
    useSimpleHttp: true,
    callback: function(res, data) {
...
function getMultimediaSource(multimediaId) {
  RPCManager.sendRequest({
    actionURL:
      "https://glibrary.ct.infn.it:3500/v2/repos/dariah/multimedia/" +
      multimediaId,
    httpHeaders: { Authorization: access_token },
    httpMethod: "GET",
    useSimpleHttp: true,
...
function getAssets(source) {
  RPCManager.sendRequest({
    actionURL:
      "https://glibrary.ct.infn.it:3500/v2/repos/dariah/assets?filter[where][path][like]=" +
      source,
    httpHeaders: { Authorization: access_token },
    httpMethod: "GET",
    useSimpleHttp: true,
...
function getAssociatedAsset(quelle_id, _callback) {
  RPCManager.sendRequest({
    actionURL:
      'https://glibrary.ct.infn.it:3500/v2/repos/dariah/assets?filter={"where":{"quelle_id":' +
      quelle_id +
      "}}",
    httpHeaders: { Authorization: access_token },
    useSimpleHttp: true,
...
function saveCorrectAssetForLemma(quelle_id, asset_id) {
  RPCManager.sendRequest({
    actionURL:
      "https://glibrary.ct.infn.it:3500/v2/repos/dariah/assets/" + asset_id,
    httpHeaders: {
...
function getAssetTempURL(id) {
  RPCManager.sendRequest({
    actionURL:
      "https://glibrary.ct.infn.it:3500/v2/repos/dariah/assets/" +
      id +
      "/_replicas",
    httpHeaders: { Authorization: access_token },
    httpMethod: "GET",
